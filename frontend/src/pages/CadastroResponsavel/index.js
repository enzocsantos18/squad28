...
function CadastroResponsavel () {
  ...
  return (
    ...
    <Container>
        ...
        <Row>
        <Col xs={9}>
            <h2 className="subtitulo">Nesta etapa faremos um cadastro especial para conhecermos melhor você</h2>
        </Col>
        </Row>
        ...
        <Row>
        <Col xs={9}>
            <h2 className="subtitulo">Para finalizar o seu cadastro insira:</h2>
        </Col>
        </Row>
        <Form.Row className="linhaForm1">
            <Form.Group as={Col} md="4" controlId="validationCustom01">            
